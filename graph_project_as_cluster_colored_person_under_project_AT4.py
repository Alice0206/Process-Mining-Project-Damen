...
# Projects = ['Project1','Project4','Project2','Project3']
    ...
    for record in tx.run(q):
        if record["e2"] != None:
            ...
            if e1_date == e2_date:
                ...
                dot.edge(e1_name,e2_name,constraint = "false",color = color,style = "invis")
                ...
                pen_width = str(edge_width)
                edge_color = color
                dot.edge(e1_name,e2_name,constraint='false',xlabel=edge_label,color=edge_color,penwidth=pen_width,fontname="Helvetica", fontsize="10",fontcolor=edge_color,style = "invis") 
                dot.attr(rankdir = 'LR')
...
# #     session.read_transaction(getProjectForFirstEvent, dot, "Project10",C15,c_white)
    ...
    session.read_transaction(getEventsDF, dot,"AT_Pro11" ,"Project", C16, c_black, 3)
    session.read_transaction(getPersonDF,dot,"Pro11_Person")
    
    session.read_transaction(getEventsDF, dot,"AT_Pro12" ,"Project", C17, c_black, 3)
    session.read_transaction(getPersonDF,dot,"Pro12_Person")
    
    session.read_transaction(getEventsDF, dot,"AT_Pro13" ,"Project", C18, c_black, 3)
    session.read_transaction(getPersonDF,dot,"Pro13_Person")
    
    session.read_transaction(getEventsDF, dot,"AT_Pro14" ,"Project", C19, c_white, 3)
    session.read_transaction(getPersonDF,dot,"Pro14_Person")
    
    session.read_transaction(getEventsDF, dot,"AT_Pro15" ,"Project", C20, c_white, 3)
    session.read_transaction(getPersonDF,dot,"Pro15_Person")
    
    session.read_transaction(getEventsDF, dot,"AT_Pro16" ,"Project", C21, c_black, 3)
    session.read_transaction(getPersonDF,dot,"Pro16_Person")
    
    session.read_transaction(getEventsDF, dot,"AT_Pro17" ,"Project", C22, c_black, 3)
    session.read_transaction(getPersonDF,dot,"Pro17_Person")
    
    session.read_transaction(getEventsDF, dot,"AT_Pro19" ,"Project", C23, c_black, 3)
    session.read_transaction(getPersonDF,dot,"Pro19_Person")
    
    session.read_transaction(getEventsDF, dot,"AT_Pro25" ,"Project", C24, c_black, 3)
    session.read_transaction(getPersonDF,dot,"Pro25_Person")
    
    session.read_transaction(getEventsDF, dot,"AT_Pro26" ,"Project", C25, c_black, 3)
